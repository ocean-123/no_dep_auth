...
//            .formLogin(form->
//                    form.loginPage("/signin").loginProcessingUrl("/userLogin").successHandler(authSuccessHandler)
//                            .permitAll()
//                            );
//
//
...
//                        oauth2Login
//
//                                .loginPage("/login").defaultSuccessUrl("/user/profile")
//                );
